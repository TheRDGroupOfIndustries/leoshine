...
function StarRow({ count = 5 }) {
  ...
  return (
    <div className="star-row d-flex mb-2 " aria-hidden="true">
      {stars.map((_, i) => (
        <svg
          key={i}
          width="18"
    ...
    <section className="testimonials-section pt-5">
      <div className="container">
        <div className="text-center mb-4">
          <h2 className="fw-bold">Loved By Millions Of Happy Customers</h2>
        ...
        <div className="position-relative">
          ...
          <div className="slider-viewport" ref={containerRef}>
            <div
              className="slider-track d-flex align-items-stretch"
              style={{
            ...
            >
              {testimonials.map((t, i) => (
                <article
                  key={i}
                  className="testimonial-card p-4 me-3"
                ...
                >
                  <div className="p-3 bg-light rounded-3 h-100 d-flex flex-column justify-content-between">
                    <div>
                      ...
                      <a href="#!" className="read-more text-danger fw-medium">
                        Read More &gt;
                      </a>
                    </div>
        ...
        <div className="d-flex justify-content-center mt-4">
          {Array.from({ length: maxIndex + 1 }).map((_, idx) => (
            <button
              key={idx}
              className={`indicator btn ${idx === index ? "active" : "btn-light"}`}
